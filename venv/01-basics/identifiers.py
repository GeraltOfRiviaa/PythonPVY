...
PI = 3.14
city = "Opava"
# hilda@sspu-opava.cz = 'Hilda Dokonalá' - v indetifikátoru nesmí být užito zvláštních znaků, jakožto !@#$%- a další
zak1 = {
    "email": "hilda@sspu-opava.cz",
    "name": "Hilda Dokonalá",
}
password2 = 'TajneHeslo'
# 007agent = 'James Bond' - nesmí být na začátku indetifikátorů číslo
agent007 = 'James Bond'
